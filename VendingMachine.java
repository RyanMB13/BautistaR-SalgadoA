...
public class VendingMachine {
    protected final ArrayList<Item> itemList;
    protected final ArrayList<Money> userCashList;
    protected double userCash;
    protected final ArrayList<Money> paymentList;
    protected double totalPayment;
    protected final ArrayList<Money> VMChangeList;
    protected double VMChange;
    protected double totalSales;
    protected int sold;

    /**
     * This generates a VendingMachine object which includes the variables itemList, userCashList, userCash,
     * VMChangeList, VMChange, and totalSales.
     */
    public VendingMachine() {
        this.itemList = new ArrayList<>();
        this.userCashList = new ArrayList<>();
        this.userCash = 12345.00;
        this.paymentList = new ArrayList<>();
        this.totalPayment = 0.00;
        this.VMChangeList = new ArrayList<>();
        this.VMChange = 18860.00;
    ...
    public void addMoney() {
        ...
        VMChangeList.add(new Money(1000, 10)); // index 0
        VMChangeList.add(new Money(500, 10)); // index 1
        VMChangeList.add(new Money(200, 10)); // index 2
        VMChangeList.add(new Money(100, 10)); // index 3
        VMChangeList.add(new Money(50, 10)); // index 4
        VMChangeList.add(new Money(20, 10)); // index 5
        VMChangeList.add(new Money(10, 10)); // index 6
        VMChangeList.add(new Money(5, 10)); // index 7
        VMChangeList.add(new Money(1, 10)); // index 8
    ...
    public void cashInput(Scanner scanner) {
        int cashInput;
        double totalCash = 0;
        int count1000 = 0;
        int count500 = 0;
     ...
     * An Item can only be bought if the price is less than or equal to userCash.
     * @param scanner the initialized scanner
     */
    ...
    /**
     * This method acts as the change producer for the user when they are finished using the vending machine.
            ...
            do {
                if (change >= 1000) {
                    if (VMChangeList.get(0).getQuantity() > 0) {
                        ...
                        System.out.println("Not enough money to produce change, please ask the owner to replenish change.");
                        break;
                    }
                } else if (change >= 500) {
    ...
    public void replenishStock(Scanner scanner) {
        ...
        System.out.println("Item " + slot + ": " + item.getName() + " Previous Stock: " + item.getStock());
        item.setStock(item.getStock() + quantity);
        System.out.println("Item " + slot + ": " + item.getName() + " Current Stock: " + item.getStock());
