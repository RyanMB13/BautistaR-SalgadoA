...
public class ReplenishChangeGUI extends JFrame {
    ...
    public ReplenishChangeGUI() {
        // title
        super("Replenish Change");
        setResizable(false);
    ...
    public void DisplayCashInput() {
        cashTrackerLabel.setText("Change to be added: ₱" + getDisplayCash());
    }
    ...
    public void displayEnteredCashMessage(double prevCash, double currCash) {
        ...
        outputList.add("Current Vending Machine Change Amount: ₱" + currCash + "\n");

        for (String s : outputList){
            message.append(s);
        }

        JOptionPane.showMessageDialog(this, message, "Replenish Change", JOptionPane.INFORMATION_MESSAGE);
